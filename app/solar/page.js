      ...
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-[#f7f9f6]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm font-bold text-slate-600 md:flex">
            ...
            <a href="#quote" className="rounded-full bg-[#0d2016] px-5 py-2.5 text-white transition hover:-translate-y-0.5">Request a quote</a>
          </nav>
        ...
        {menuOpen && (
          <nav className="border-t border-slate-200 bg-white px-5 py-4 md:hidden">
            <div className="mx-auto flex max-w-7xl flex-col gap-1">
              ...
              <a href="#quote" onClick={() => setMenuOpen(false)} className="mt-2 rounded-xl bg-[#0d2016] px-4 py-3 text-center font-black text-white">Request a quote</a>
            </div>
          </nav>
        )}
      </header>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-14 sm:py-20 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-8 lg:py-24">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a href="#quote" className="rounded-2xl bg-[#d9ff48] px-7 py-4 text-center text-sm font-black text-[#0d2016] shadow-xl shadow-lime-950/20 transition hover:-translate-y-1">Check availability →</a>
      ...
      <section id="quote" className="bg-[#0d2016] px-5 py-20 sm:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-7 text-emerald-50/75">Send your details and the devices you want to run. We&apos;ll help you check suitability, availability and the right setup before you commit.</p>
          ...
          <div className="rounded-[2rem] bg-white p-6 shadow-2xl sm:p-8">
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full rounded-xl bg-[#0d2016] px-5 py-4 text-sm font-black text-[#d9ff48] transition hover:-translate-y-0.5 hover:bg-[#163824]">Request availability & pricing →</button>
                <p className="text-center text-xs leading-5 text-slate-400">No payment is taken here. This is an enquiry for product availability, pricing and suitability.</p>
              </form>
            )}
          </div>
        </div>
